...
let UsersResolvers = class UsersResolvers {
    ...
    findOneById(obj, args, context, info) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = args;
    ...
    create(obj, args, context, info) {
        return __awaiter(this, void 0, void 0, function* () {
            const createdUser = yield this.usersService.create(args);
            return createdUser;
        });
    }
};
__decorate([
    graphql_1.Query(),
    common_1.UseGuards(users_guard_1.UsersGuard),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
], UsersResolvers.prototype, "create", null);
